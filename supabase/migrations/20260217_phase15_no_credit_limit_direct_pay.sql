-- ============================================================================
-- Phase 15: Allow direct-pay ordering when no credit limit is assigned
-- Date: 2026-02-17
-- Purpose:
--   1) Keep credit checks for credit-account clients
--   2) Allow clients with no/zero credit limit to place orders as direct pay
--   3) Persist direct-pay orders with payment_terms = 'prepay' when available
-- ============================================================================
...
VALUES ('20260217_phase15_no_credit_limit_direct_pay.sql')
